  ...
  return (
    ...
    >
      ...
      <div 
        ...
        style={{ transform: 'translateY(-111px)' }} /* Przesunięcie w górę o 5px */
      >
        {/* Holder Image */}
        <img
          src="/holder2.png" 
          alt="Crystal Holder"
          className="absolute w-[150px] h-[200px] left-1/2 -translate-x-1/2 z-50 filter-white-invert" /* Przywrócono filter-white-invert */
        />

...
export const PowerCrystal: React.FC<PowerCrystalProps> = React.memo(({ onCrystalClick }) => {
  ...
  const [crystalProps, setCrystalProps] = useLocalStorage('adhd-crystal-props', {
    top: 13, // Dostosowano pozycję Y kryształu
    left: 24, // Dostosowano pozycję X kryształu
    size: 80, // Zmniejszono rozmiar kryształu
  });
  ...
  return (
    ...
    >
      ...
      <div className="relative w-32 h-32 flex items-center justify-center"> {/* Zmieniono w-96 h-96 na w-32 h-32 */}

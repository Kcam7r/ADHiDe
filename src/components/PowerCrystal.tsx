...
export const PowerCrystal: React.FC<PowerCrystalProps> = React.memo(({ onCrystalClick }) => {
  ...
  const crystalPropsArray = useLocalStorage('adhd-crystal-props', {
  ...
  const crystalProps = crystalPropsArray[0]; // Jawne pobranie pierwszego elementu
  ...
  return (
    <div
      className="relative flex flex-col items-center justify-center w-full cursor-pointer select-none -translate-y-8"

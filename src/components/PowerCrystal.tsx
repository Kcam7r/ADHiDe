    ...
    >
      ...
      >
        ...
        <img
          src="/holder4.png" 
          alt="Crystal Holder"
          className="absolute w-[250px] h-[250px] z-[6] filter-tree-color group-hover:filter-white-invert-hover transition-filter duration-300" // Zmieniono rozmiar
          style={{ 
            top: 30, // Dostosowano pozycję
            left: -13, // Dostosowano pozycję
          }}
        />

    ...
    >
      ...
      >
        ...
        <img
          src="/holder4.png" 
          alt="Crystal Holder"
          className="absolute w-[280px] h-[280px] z-[6] filter-tree-color group-hover:filter-white-invert-hover transition-filter duration-300" // Zmieniono rozmiar
          style={{ 
            top: 15, // Dostosowano pozycję

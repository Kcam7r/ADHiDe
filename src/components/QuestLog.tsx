      ...
      <div className="max-w-4xl mx-auto h-full flex flex-col">
        ...
        {activeTab === 'habits' && (
          <div className="bg-gray-800 rounded-lg p-6 flex-1 flex flex-col min-h-0 overflow-hidden">
            ...
            <div className="flex-1 min-h-0 h-0">
              <ScrollableList emptyMessage="Brak nawyków do wyświetlenia" itemHeightPx={82} itemMarginYPx={12}>
                {renderHabitItems()}
              </ScrollableList>
            </div>
          </div>
        ...
        {activeTab === 'daily' && (
          <div className="bg-gray-800 rounded-lg p-6 flex-1 flex flex-col min-h-0 overflow-hidden">
            ...
            <div className="flex-1 min-h-0 h-0">
              <ScrollableList emptyMessage="Brak zadań codziennych" itemHeightPx={68} itemMarginYPx={12}>
        ...
        {activeTab === 'missions' && (
          <div className="bg-gray-800 rounded-lg p-6 flex-1 flex flex-col min-h-0 overflow-hidden">
            ...
            <div className="flex-1 min-h-0 h-0">
              <ScrollableList emptyMessage="Brak zadań do wyświetlenia" itemHeightPx={94} itemMarginYPx={12}>
                {renderMissionItems()}
              </ScrollableList>
            </div>
          </div>
